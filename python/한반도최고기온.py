...
asdf=[서울,부산,대구,인천,광주,대전,울산,경기도,강원도,충청북도,충청남도,전라북도,전라남도,경상북도,경상남도,제주도]
a = []
for i in asdf:
    html = urlopen(i)
...
<head>
	...
	<svg version="1.1" id="svgMap" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 width="100%" height="500px" viewBox="0 0 591 840" enable-background="new 0 0 422 500" xml:space="preserve">
		<g i:extraneous="self">
			<g name="서울" class="md-trigger" data-modal="modal-3" id="svgSeoul" i:layer="yes" i:dimmedPercent="50" i:rgbTrio="#000000000000" seq="1">
				<path i:knockout="Off" fill='''+a[0]+''' stroke="#FFFFFF" d="M183.5,256.583l1.188,4.667L183,263.083l1.375,3.792l2.938-1.313
			...
			<g name="인천" class="md-trigger" data-modal="modal-3" id="svgInchun" i:layer="yes" i:dimmedPercent="50" i:rgbTrio="#4F00FFFF4F00" seq="2">
				<path i:knockout="Off" fill='''+a[3]+''' stroke="#FFFFFF" d="M174.667,265l-0.083-4.25l1.917-1.583v-0.75l0.583-4.833l3-4
			...
			<g name="경기"  class="md-trigger" data-modal="modal-3" id="svgKyungi" i:layer="yes" i:dimmedPercent="50" i:rgbTrio="#4F004F00FFFF" seq="3">
				<path i:knockout="Off" fill='''+a[7]+''' stroke="#FFFFFF" d="M312.167,254.167l-6.334-5l-4-1.667h-8l-12.333-8.167l-6.167,3
			...
			<g name="충북" class="md-trigger" data-modal="modal-3" id="svnChungcheong " i:layer="yes" i:dimmedPercent="50" i:rgbTrio="#FFFFFFFF4F00" seq="4">
				<path i:knockout="Off" fill='''+a[9]+''' stroke="#FFFFFF" d="M409.5,324.333l-6.167,0.833l-8-4.833l-3.958,0.792l-7.208,0.375
			...
			<g name="충남" id="svnChungnam" i:layer="yes" i:dimmedPercent="50" i:rgbTrio="#000000000000">
				<path i:knockout="Off" fill='''+a[10]+''' stroke="#FFFFFF" d="M287.167,484.5l-2.5-5.833l-3.5-3.334l1.5-3.5l-0.167-4l-0.667-4.666
			...
			<g name="강원" id="svgKangwon" i:layer="yes" i:dimmedPercent="50" i:rgbTrio="#4F00FFFF4F00">
				<path i:knockout="Off" fill='''+a[8]+''' stroke="#FFFFFF" d="M499.5,305.167l0.333-1.667l-0.833-2l2.833-1.667l-4.666-7.5
			...
			<g class="md-trigger" data-modal="modal-3" name="광주" id="svgGwangju" i:layer="yes" i:dimmedPercent="50" i:rgbTrio="#4F00FFFFFFFF" seq="5">
				<path i:knockout="Off" fill='''+a[4]+''' stroke="#FFFFFF" d="M207.334,628.25l1.5-1.417l-2.25-2.916L203.417,624l-2-1.917
			...
			<g class="md-trigger" data-modal="modal-3" name="대전" id="svgDaejeon" i:layer="yes" i:dimmedPercent="50" i:rgbTrio="#4F008000FFFF" seq="6">
				<path i:knockout="Off" fill='''+a[5]+''' stroke="#FFFFFF" d="M275.667,433l-0.5-1.667L272,430.875L270.625,433l-2.125-3.625V429
			...
			<g class="md-trigger" data-modal="modal-3" name="울산" id="svgUlsan" i:layer="yes" i:dimmedPercent="50" i:rgbTrio="#4F00FFFF4F00" seq="7">
				<path i:knockout="Off" fill='''+a[6]+''' stroke="#FFFFFF" d="M520.875,554.5l-2.125-3l-1.25-4.5l-10.25-4.25L500,547.5l-4.5-1.625
			...
			<g class="md-trigger" data-modal="modal-3" name="경북" id="svgKyungbuk" i:layer="yes" i:dimmedPercent="50" i:rgbTrio="#4F008000FFFF" seq="8">
				<path i:knockout="Off" fill='''+a[13]+''' stroke="#FFFFFF" d="M532.75,481l-2-2l-5.75,8.75l-3.25,2.25l-2.75,4l-5.25-2.75
			...
			<g class="md-trigger" data-modal="modal-3" name="경남" id="svgKyungnam" i:layer="yes" i:dimmedPercent="50" i:rgbTrio="#4F004F00FFFF" seq="9">
				<path i:knockout="Off" fill='''+a[14]+''' stroke="#FFFFFF" d="M487.75,581.75l-5.625,0.375l-6.375-8.875l-5-3.5l-6.5-0.75
			...
			<g class="md-trigger" data-modal="modal-3" name="부산" id="svgBusan" i:layer="yes" i:dimmedPercent="50" i:rgbTrio="#FFFFFFFF4F00" seq="10">
				<path i:knockout="Off" fill='''+a[1]+'''stroke="#FFFFFF" d="M499.125,596.5l-0.375-5.25L496,589.5l-2.125,0.5L489,589.25
			...
			<g name="제주" id="svgJeju" i:layer="yes" i:dimmedPercent="50" i:rgbTrio="#000000000000">
				<path i:knockout="Off" fill='''+a[15]+''' stroke="#FFFFFF" d="M532.167,742.667l-1.334-2l-3.166-2.5l0.5-3.5l-0.5-4l-2.834-0.167
			...
			<g name="대구" id="svgDaegu" i:layer="yes" i:dimmedPercent="50" i:rgbTrio="#FFFF4F004F00">
				<path i:knockout="Off" fill='''+a[2]+''' stroke="#FFFFFF" d="M427.75,505.75l-0.5-9l-1.25-3.5l-3.833-1.084l-8.834,0.001
			...
			<g name="전북" id="svgJunbuk" i:layer="yes" i:dimmedPercent="50" i:rgbTrio="#FFFF4F00FFFF">
				<path i:knockout="Off" fill='''+a[11]+''' stroke="#FFFFFF" d="M323,503.5l-5.167-7.333l-0.5-3.334L313.5,491l-10.167,3.333
			...
			<g name="전남" id="svgJunam" i:layer="yes" i:dimmedPercent="50" i:rgbTrio="#800080008000">
				<path i:knockout="Off" fill='''+a[12]+''' d="M287.25,668H293l6.5-7.5l2-0.75l3.167-3.083l2.333-2.334l0.667-3.833l-1.834,0.167
	...
	<script>
		...
		$("g").mouseover(function(event) {
			...
			d3.select(_path).style("fill", "blue");
...
/*
		...
		$("g").on("click", function(event) {
			var _path = event.target;
			var city_name = _path.name;
			var province = $(_path).parent()[0].id;
			alert($("#"+province).attr("name"));
		});
*/
	</script>
